package com.systems.microservicesapplication.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microservicesApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("microservicesApplication");
        ...
        config.getMapConfigs().put("com.systems.microservicesapplication.domain.*", initializeDomainMapConfig(jHipsterProperties));
